...
OBJ = AtWar.o World.o Animation.o AnimatedSprite.o MusicPlayer.o SoundPlayer.o AnimationData.o HeroSoundPlayer.o PostEffect.o BloomEffect.o Projectile.o Hero.o HeroMover.o HeroAttacker.o GameController.o Data.o Entity.o SceneNode.o SoundNode.o SpriteNode.o Component.o Container.o Button.o Command.o CommandQueue.o PlayerInput.o StateStack.o State.o TitleState.o MenuState.o MultiplayerMenuState.o SettingsState.o GameState.o MultiplayerGameState.o PauseState.o MultiplayerServer.o KeyToString.o
