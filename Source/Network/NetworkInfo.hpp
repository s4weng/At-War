...
enum ServerPacketType {
	...
	PositionUpdate, //sf::Int32 id, float posX, float posY; passes new position of any entity
	...
	SpawnEnemy, //sf::Int32 id, int heroClass, float posX, float posY; passes newly spawned enemy
